...
import facades.TorneiosUsersFacade;
...
@Named("torneiosUsersController")
@SessionScoped
public class TorneiosUsersController implements Serializable {

    private TorneiosUsers current;
    private DataModel items = null;
    @EJB
    private facades.TorneiosUsersFacade ejbFacade;
    private PaginationHelper pagination;
    private int selectedItemIndex;

    public TorneiosUsersController() {
    }
    ...
    private TorneiosUsersFacade getFacade() {
        return ejbFacade;
    }
    ...
    public String prepareView() {
        current = (TorneiosUsers) getItems().getRowData();
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("TorneiosUsersDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class TorneiosUsersControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            TorneiosUsersController controller = (TorneiosUsersController) facesContext.getApplication().getELResolver().
                    getValue(facesContext.getELContext(), null, "torneiosUsersController");
